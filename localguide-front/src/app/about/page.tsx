      ...
      <div className="relative overflow-hidden bg-emerald-600">
        <div className="mx-auto max-w-6xl px-6 py-16 text-white">
          ...
          <p className="mt-3 max-w-2xl text-white/90">
            แพลตฟอร์มที่เชื่อมนักเดินท่องเที่ยวกับไกด์ท้องถิ่น
            เพื่อประสบการณ์ท่องเที่ยวที่จริงใจและเข้าถึงพื้นที่นั้น อย่างแท้จริง
            อีกทั้งยังได้สัมผัสถึงวัฒนธรรมท้องถิ่น อาหารพื้นเมือง
            และสาวสวยสุดน่ารัก
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-12 grid gap-10 md:grid-cols-3">
          <div className="md:col-span-2">
            <h2 className="text-xl font-bold text-gray-900">
              เราเชื่อในการท่องเที่ยวที่จริงใจ
            </h2>
            <p className="mt-3 text-gray-700 leading-relaxed">
              Localguide ช่วยให้คุณค้นหาและจองไกด์ท้องถิ่นได้ง่ายขึ้น
              ทั้งการเดินทางเชิงวัฒนธรรม ธรรมชาติ อาหาร
              หรือกิจกรรมพิเศษในพื้นที่
              เราตั้งใจทำให้ทุกทริปมีความหมายกับผู้เดินทาง
              และสร้างรายได้อย่างยั่งยืนให้กับคนในชุมชน
            </p>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 p-5">
                ...
                <p className="mt-2 text-gray-700">
                  ...
                  นักเดินทางได้ประสบการณ์จริง ไกด์มีรายได้ยุติธรรม
                  และชุมชนเติบโตอย่างยั่งยืน
                </p>
              </div>
              <div className="rounded-2xl border border-gray-200 p-5">
          ...
          <div className="h-fit rounded-2xl border border-gray-200 p-6">
            ...
            <div className="mt-4 space-y-4 text-gray-700">
              <div>
                ...
                <p className="mt-1">
                  Kamphaeng Saen, Kamphaeng Saen District,
                  <br />
                  Nakhon Pathom 73140
                </p>
              </div>
