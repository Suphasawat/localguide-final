...
export default function AdminDashboard() {
  ...
  const verificationCount = Array.isArray(verifications) ? verifications.length : 0;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-2xl bg-white/10 backdrop-blur p-4 border border-white/20">
              <div className="text-sm text-emerald-100">คำขออนุมัติค้างอยู่</div>
              <div className="mt-1 text-2xl font-bold text-white">
                {verificationCount}
              </div>
            </div>
            <div className="rounded-2xl bg-white/10 backdrop-blur p-4 border border-white/20">
              <div className="text-sm text-emerald-100">รายงานที่ต้องตรวจสอบ</div>
              <div className="mt-1 text-2xl font-bold text-white">
                {reportCount}
              </div>
            </div>
